...
import forestRoad from '../assets/connect.png'
import futurePlan from '../assets/about_future.png'
  ...
  return (
    <>
      ...
      <div style={styles.container}>
        ...
        <img src={forestRoad} className="img-fluid rounded" alt="road from forest"></img>
        <br /><br /><h4>
        ...
        <img src={futurePlan} className="img-fluid rounded" alt="future_photo"></img>
        <br /><br />
        <ul>
